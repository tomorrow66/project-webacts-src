...
gulp.task('styles', ['wiredep', 'injector:css:preprocessor'], function () {
  return gulp.src(['src/app/styles/index.scss'])
...
gulp.task('build', ['html', 'images', 'videoData', 'fonts', 'misc']);
